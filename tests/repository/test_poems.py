...
class TestPoemRepository:
    ...
    async def test_create_poem_success(self, db_session: AsyncSession, sample_poem_data):
    ...
    @pytest.mark.asyncio
    @pytest.mark.repository
    async def test_create_duplicate_poem_fails(self, db_session: AsyncSession, sample_poem: Poem, sample_poem_data):
    ...
    @pytest.mark.asyncio
    @pytest.mark.repository
    async def test_create_invalid_language_fails(self, db_session: AsyncSession, sample_poem_data, mock_language_validator):
        ...
        with patch('vpsweb.repository.poems.validate_language_code', return_value=(False, "Invalid language")):
    ...
    @pytest.mark.asyncio
    @pytest.mark.repository
    async def test_update_poem_success(self, db_session: AsyncSession, sample_poem: Poem):
    ...
    @pytest.mark.asyncio
    @pytest.mark.repository
    async def test_delete_poem_success(self, db_session: AsyncSession, sample_poem: Poem):
    ...
    @pytest.mark.asyncio
    @pytest.mark.repository
    async def test_search_by_language(self, db_session: AsyncSession, sample_poem: Poem):
    ...
    async def test_get_by_language(self, db_session: AsyncSession, sample_poem: Poem):
        ...
        assert len(poems) >= 1
        assert total >= 1
        assert all(poem.source_language == sample_poem.source_language for poem in poems)
    ...
    async def test_get_by_poet(self, db_session: AsyncSession, sample_poem: Poem):
        ...
        assert len(poems) >= 1
        assert total >= 1
        assert all(sample_poem.poet_name.lower() in poem.poet_name.lower() for poem in poems)
    ...
    @pytest.mark.asyncio
    @pytest.mark.repository
    async def test_get_language_distribution(self, db_session: AsyncSession, sample_poem: Poem):
    ...
    @pytest.mark.asyncio
    @pytest.mark.repository
    async def test_bulk_update_status(self, db_session: AsyncSession, sample_poem: Poem):
        """Test bulk updating poem status."""
        repo = PoemRepository(db_session)

        result = await repo.bulk_update_status(
            poem_ids=[sample_poem.id],
            is_active=False
        )
    ...
    @pytest.mark.asyncio
    @pytest.mark.repository
    async def test_list_with_pagination(self, db_session: AsyncSession, sample_poem: Poem):
    ...
    @pytest.mark.asyncio
    @pytest.mark.repository
    async def test_get_by_title_and_poet(self, db_session: AsyncSession, sample_poem: Poem):
        """Test getting poem by title and poet."""
        repo = PoemRepository(db_session)

        found_poem = await repo.get_by_title_and_poet(
            sample_poem.poem_title,
            sample_poem.poet_name
        )
    ...
    @pytest.mark.asyncio
    @pytest.mark.repository
    async def test_database_error_handling(self, db_session: AsyncSession, raise_database_error):
