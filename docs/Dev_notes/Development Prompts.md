...
1. Can you access the vpsweb project at https://github.com/OCboy5/vpsweb and study it thoroughly? It can now work as an AI-driven poetry translation production system.
...
please move on with the generation of PSD based on our mutually agreed strategy doc at docs/Strategy_Collections/strategy_repo_cc.md. The PSD should have enough details and clarity for the next phase technical implementation. Please think very hard, and use mcp tools like context7, deepwiki etc. as you regard necessary. you should create the PSD in markdown format, and save it to docs/PSD_Collection/drafts/PSD_repo_cc_draft.md. Since it's a long and comprehensive process, please output your interim work-in-progress results to the output file on the fly so even you can not finish the tasks in one batch, you can know where to recover.

please review the 2 uploaded docs. PSD_repo_cc_draft.md is a project specification document generated according to the project strategy doc strategy_repo_cc.md. Please act as an senior software architect,  try to find loopholes, redundancies, outdated tools and apis, confusing issues in the document,  by the standard of quality, completeness and robustness of a professional PSD for a software project.

please review the 2 uploaded docs. ToDos.md is a project specification document generated according to the project specification doc PSD_repo_cc.md. Please act as an senior software architect,  try to find loopholes, redundancies, unnecessary tasks, confusing statements in the document,  by the standard of quality, completeness and robustness of a professional project plan for a software project.

 I've beening reviewing the codes completed so far. I'm a little surprised on the size of the codebase and the complexity it has so far. I intend to build a prototype of the central repository and WebUI for personal use first, and scale and enhance it for production use in the future. The current approach is a little bit heavy weight and difficult to maintain for that intention. It's not your fault. I didn't make my ideas clear enough. Let's review what we have done, and debate what can be done differently to build a fast-track prototype with a foundation for future enhancement. Please don't change any thing we have done before we reach an agreement.

 the development phase has completed and committed to https://github.com/OCboy5/vpsweb. The implementation is based on the PSD file at docs/PSD_Collection/drafts/PSD_repo_CC_v0.3.1.md, and the detail project tracking document is at ToDos.md. Act as an expert in software architect, software development and project management, please give the current v0.3.1 release a thorough project review and code review. Please output your result in markdown format. 