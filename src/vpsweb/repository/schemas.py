...
class WorkflowTaskCreate(BaseSchema):
    ...
    poem_id: str = Field(..., description="ID of the poem to translate")
    source_lang: str = Field(..., min_length=2, max_length=10, description="Source language code")
...
class WorkflowTaskResponse(BaseSchema):
    ...
    duration_seconds: Optional[int] = Field(None, description="Task duration in seconds")
