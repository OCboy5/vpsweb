...
def upgrade() -> None:
    ...
    # Create indexes
    op.create_index('idx_bbr_poem_id', 'background_briefing_reports', ['poem_id'], unique=False)
    op.create_index('idx_bbr_created_at', 'background_briefing_reports', ['created_at'], unique=False)
    op.create_index('idx_bbr_cost', 'background_briefing_reports', ['cost'], unique=False)
    op.create_index('idx_bbr_time_spent', 'background_briefing_reports', ['time_spent'], unique=False)
